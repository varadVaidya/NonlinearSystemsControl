...
\pgfplotsset{ % Define a common style, so we don't repeat ourselves
  simplePhase/.style={
    ...
    xmin=-3.1, xmax=3.1, % Axis limits
    ymin=-3.1, ymax=3.1,
    domain=-3:3, y domain=-3:3, % Domain over which to evaluate the functions
    xtick={-3,-2,...,3}, ytick={-3,-2,...,3}, % Tick marks %
    samples=13, % How many arrows?
    ...
    darkgray,
      ...
      red, samples=31, smooth, thick, no markers, domain=-3:3\\ % The plot style for the function
    }
  }
}
